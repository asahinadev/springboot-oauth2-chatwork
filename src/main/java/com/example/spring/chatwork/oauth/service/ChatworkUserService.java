package com.example.spring.chatwork.oauth.service;
...
import com.example.spring.chatwork.oauth.interceptor.LoggingClientHttpRequestInterceptor;
...
public class ChatworkUserService
	...
	public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
		...
		if (!Objects.equals(registrationId, "chatwork")) {
			return null;
		}
		...
		try {
			...
			response = this.restTemplate.exchange(request, ChatworkUser.class);
